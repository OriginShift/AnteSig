...
Issue [#9](https://github.com/OriginShift/AnteSig/issues/9) owns this
documentation delivery. Tracker
[#4](https://github.com/OriginShift/AnteSig/issues/4) separately owns
the M1 closure assessment. At this snapshot, both Issues and the
[M1 Milestone](https://github.com/OriginShift/AnteSig/milestone/2)
...
[`quality-gate` run](https://github.com/OriginShift/AnteSig/actions/runs/30937008262)
and its
[`quality-gate` job](https://github.com/OriginShift/AnteSig/actions/runs/30937008262/job/92085564423):
...
| --- | --- | --- | --- | --- |
| [#3](https://github.com/OriginShift/AnteSig/issues/3) | M1-01 TypeScript workspace and quality gate | [PR #10](https://github.com/OriginShift/AnteSig/pull/10) | `edd37e0b977fe2821752dda4d4c3b4715238ffe8` | [run 30131866900](https://github.com/OriginShift/AnteSig/actions/runs/30131866900) |
| [#4](https://github.com/OriginShift/AnteSig/issues/4) | M1 delivery tracker and separate closure assessment | GitHub Issue is the live control record | No closure commit at this snapshot | Requires a future exact-main assessment after #9 |
| [#5](https://github.com/OriginShift/AnteSig/issues/5) | M1-02 PreflightReport v0.1 runtime Schema | [PR #15](https://github.com/OriginShift/AnteSig/pull/15) | `a210d9c297ddef4b42648b2c1343da5b9c19a407` | [run 30263166240](https://github.com/OriginShift/AnteSig/actions/runs/30263166240) |
| [#6](https://github.com/OriginShift/AnteSig/issues/6) | M1-03 fail-closed Decision Engine | [PR #66](https://github.com/OriginShift/AnteSig/pull/66) | `aa7ea761b2ac5e78535387e0a7d04d45485cdfb1` | [run 30833497929](https://github.com/OriginShift/AnteSig/actions/runs/30833497929) |
| [#7](https://github.com/OriginShift/AnteSig/issues/7) | M1-04 MANUAL_REVIEW success Fixture | [PR #16](https://github.com/OriginShift/AnteSig/pull/16) | `316dd1478b46185df862be80499963e42d73855b` | [run 30277600027](https://github.com/OriginShift/AnteSig/actions/runs/30277600027) |
| [#8](https://github.com/OriginShift/AnteSig/issues/8) | M1-05 tokenOut mismatch STOP Fixture | [PR #67](https://github.com/OriginShift/AnteSig/pull/67) | `c52384448e0016d36f2e723f8cdf37f10315e1c8` | [run 30870163331](https://github.com/OriginShift/AnteSig/actions/runs/30870163331) |
| [#9](https://github.com/OriginShift/AnteSig/issues/9) | M1-06 evidence-boundary and completion-criteria documentation | GitHub Issue is the live lifecycle record | Not predeclared by this evidence snapshot | Future exact-head and merged-main CI are required |
| [#18](https://github.com/OriginShift/AnteSig/issues/18) | M1-07 DecisionInput/MANUAL_REVIEW contract clarification | [Maintainer Accepted record](https://github.com/OriginShift/AnteSig/issues/18#issuecomment-5133046404) | Decision-only Issue; runtime correction delivered by #19 | Runtime evidence is recorded with #19 |
| [#19](https://github.com/OriginShift/AnteSig/issues/19) | M1-08 ADR 0004 DecisionInput and strict STOP boundary | [PR #65](https://github.com/OriginShift/AnteSig/pull/65) | `27a9bc66f483a25d6602fdac2748099bfb32d67e` | [run 30604382716](https://github.com/OriginShift/AnteSig/actions/runs/30604382716) |
| [#20](https://github.com/OriginShift/AnteSig/issues/20) | M1-09 amountIn mismatch STOP Fixture | [PR #68](https://github.com/OriginShift/AnteSig/pull/68) | `9e0d5c074517c3f95ab2ccecc35c2c0176ef7faf` | [run 30937008262](https://github.com/OriginShift/AnteSig/actions/runs/30937008262) |
...
| --- | --- | --- | --- |
| [ADR 0001](./adr/0001-preflight-report-v0-1-schema-contract.md) | [PR #13](https://github.com/OriginShift/AnteSig/pull/13) | `241befaed79177229385c24811805908299768a2` | [run 30153270916](https://github.com/OriginShift/AnteSig/actions/runs/30153270916) |
| [ADR 0002](./adr/0002-preflight-report-v0-1-implementation-values.md) | [PR #14](https://github.com/OriginShift/AnteSig/pull/14) | `7f9c143e6c6b1cd4e161156fa8a5f6015f72a477` | [run 30158117333](https://github.com/OriginShift/AnteSig/actions/runs/30158117333) |
| [ADR 0003](./adr/0003-decision-engine-v0-1-contract.md) | [PR #17](https://github.com/OriginShift/AnteSig/pull/17) | `29d2cbcbb815eee81f16773b1487991386303c60` | [run 30207909234](https://github.com/OriginShift/AnteSig/actions/runs/30207909234) |
| [ADR 0004](./adr/0004-decision-input-and-stop-reason-correction.md) | #18 decision, implemented by [PR #65](https://github.com/OriginShift/AnteSig/pull/65) | `27a9bc66f483a25d6602fdac2748099bfb32d67e` | [run 30604382716](https://github.com/OriginShift/AnteSig/actions/runs/30604382716) |
| [STOP presentation requirements](./stop-presentation.md) | [Issue #11](https://github.com/OriginShift/AnteSig/issues/11) / [PR #12](https://github.com/OriginShift/AnteSig/pull/12) | `7bbbc8bb9b4acb859bc73ba2b861f657864cce5c` | [run 30752494660](https://github.com/OriginShift/AnteSig/actions/runs/30752494660) |
...
- [#22](https://github.com/OriginShift/AnteSig/issues/22) is the
  accepted and closed M2 runtime and module-boundary decision.
- [#23](https://github.com/OriginShift/AnteSig/issues/23),
  [#24](https://github.com/OriginShift/AnteSig/issues/24), and
  [#32](https://github.com/OriginShift/AnteSig/issues/32) are Ready
